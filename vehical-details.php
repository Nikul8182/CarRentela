...
<link rel="shortcut icon" href="assets/images/favicon-icon/car-rent.png">
...
<section class="listing-detail">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-9  recent-car-list ">
        <div class="main_features recent-car-list">
          <ul class="myulvinfo">
          
            <li> <img width="94" height="94" src="assets/images/favicon-icon/3d-calendar.png" alt="gas-station"/></i>
              <h5><?php echo htmlentities($result->ModelYear);?></h5>
              <p>Reg.Year</p>
            </li>
            <li> <img width="94" height="94" src="assets/images/favicon-icon/gas-pump.png" alt="gas-station"/></i>
              <h5><?php echo htmlentities($result->FuelType);?></h5>
              <p>Fuel Type</p>
            </li>
       
            <li> <img width="94" height="94" src="assets/images/favicon-icon/group.png" alt="seat-capacity"/></i>
              <h5><?php echo htmlentities($result->SeatingCapacity);?></h5>
              <p>Seats</p>
            <!-- </li>
            <li> <img  src="assets/images/abstract-electric-car-service.png" alt="seat-capacity"/></i>
            </li> -->
          </ul>
        </div>
...
<?php }} ?>
      ...
      <!--Side-Bar-->
      <aside class="col-md-3 asidebar1">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><img width="94" height="94" src="assets/images/favicon-icon/icons8-bill-94.png" alt="Bill"/></i>Book Now</h5>
          </div>
          <form method="post">
