  ...
  <div class="container">
    <div class="page-header_wrap">
      <div class="page-heading text-dark">
        <h1 textcolor="black">Car Listing</h1>
      </div>
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>" class="btn round-btn">View Details <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a>
          </div>
        </div>
      <?php }} ?>
         </div>
